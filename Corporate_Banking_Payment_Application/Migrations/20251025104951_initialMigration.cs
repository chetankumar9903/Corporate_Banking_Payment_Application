    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchTransactions", x => x.BatchId);
                    table.ForeignKey(
                        name: "FK_BatchTransactions_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryDisbursements_BatchTransactions_BatchId",
                        column: x => x.BatchId,
                        principalTable: "BatchTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchTransactions_ClientId",
                table: "BatchTransactions",
                column: "ClientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryDisbursements_BatchId",
